...
function updateCart(phone) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/update-cart', phone).then(function (res) {
    //console.log(res)
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksecond_app"] = self["webpackChunksecond_app"] || [];
